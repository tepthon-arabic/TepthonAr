...
async def inline_alive(o):
    TLINK = inline_pic() or "https://graph.org/file/c0c898f1370417fbfc018.jpg"
    MSG = "• **تيبثون العربي •**"
    WEB0 = InputWebDocument(
        "https://graph.org/file/c0c898f1370417fbfc018.jpg", 0, "image/jpg", []
    )
    RES = [
...
async def setting(event):
    ...
    await event.edit(
        ...
        buttons=[
            [
                Button.inline("•بنك•", data="pkng"),
                Button.inline("•مدة التشغيل•", data="upp"),
            ],
            [
                Button.inline("•الحالة•", data="alive"),
                Button.inline("•تحديث•", data="doupdate"),
            ],
...
async def _(event):
    ...
    if len(changelog_str) > 1024:
        ...
        await event.edit(
            ...
            buttons=[
                [Button.inline("• تحديث الان •", data="updatenow")],
                [Button.inline("« رجوع", data="ownr")],
            ],
        )
